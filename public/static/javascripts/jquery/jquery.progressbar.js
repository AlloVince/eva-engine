	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '/skins/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/skins/images/progressbg_red.gif',
									30: '/skins/images/progressbg_orange.gif',
									70: '/skins/images/progressbg_green.gif'
								},

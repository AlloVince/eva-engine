...
$.widget( "ui.grid", {
	_create: function() {
		var that = this;
		this.element.addClass( "ui-widget ui-grid" );
		this.element.find( "thead th" ).addClass( "ui-widget-header" ).wrapInner('<div class="ui-grid-title-text" />');
		this.element.find( "tbody th" ).addClass( "ui-widget-title ui-grid-title ui-state-default" ).wrapInner('<div class="ui-grid-title-text" />');
		this.element.find( "td" ).addClass( "ui-widget-content ui-grid-content" ).wrapInner('<div class="ui-grid-content-text" />');
	}
});
